...
var1=IntVar()
Checkbutton(rad,text="Mango Milkshake=250",variable=var1).grid(row=1,sticky='W')

var2=IntVar()
Checkbutton(rad,text="White Russian = 400",variable=var2).grid(row=2,sticky='W')

var3=IntVar()
Checkbutton(rad,text="OJ Simpson Juice = 100",variable=var3).grid(row=3,sticky='W')
