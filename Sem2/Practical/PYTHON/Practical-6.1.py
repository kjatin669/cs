...
rad = Tk()
rad.title('Reshma Beauty Parlour')
...
var1=IntVar()
Checkbutton(rad,text="Hairstyling = 1000",variable=var1).grid(row=1,sticky='W')

var2=IntVar()
Checkbutton(rad,text="Spa = 5000",variable=var2).grid(row=2,sticky='W')

var3=IntVar()
Checkbutton(rad,text="Complete Makeover = 10000",variable=var3).grid(row=3,sticky='W')
